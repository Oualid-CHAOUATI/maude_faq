class DeleteNationalityHandler {
  constructor() {
    ...
    this.modalConfirmDeleteBtn = this.modal.querySelector(
      "#confirm-delete-btn"
    );
  ...
  setNationalityToDelete(anchor) {
    ...
    this.modalConfirmDeleteBtn.setAttribute(
      "href",
      this.deleteBaseURL + this.nationalityNumber
    );
  }
}
